...
namespace ASL
{
    public partial class GameLiftManager
    {
        ...
        public class GameController
        {
            ...
            /// </summary>
            public void SyncronizeID(Scene _scene, LoadSceneMode _mode)
            {
                Debug.Log("Sending Synchronizing Ids...: " + _scene.name);
                ...
                if (m_StartingASLObjects.Length > 0 && m_ObjectIDAssignedCount == 0)
                {
